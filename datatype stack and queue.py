...
# pa6i apde ama new ghanu add kari sakie jemk length of stack avi rite ghanu 
...
#         else:
#             first_element = q[0] 
#             del q[0]#jyare first program ma apde ahiya del ni jagyae pop no use karta mate e delete pa6adthi j thatu tu
